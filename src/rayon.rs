use crate::{correlation, indexed::UserIdx, CorrSet, Question, Row};
use float_ord::FloatOrd;

use indexical::{impls::SimdRefIndexSet as IndexSet, index_vec::IndexVec, IndexedDomain};
use indicatif::ProgressIterator;
use itertools::Itertools;
use rayon::prelude::{ParallelBridge, ParallelIterator};

pub struct RayonCorrSet;

impl CorrSet for RayonCorrSet {
